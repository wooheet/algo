...
def solution(str1, str2):
    ...
    list1 = [str1[n:n+2].lower() for n in range(len(str1)-1) if str1[n:n+2].isalpha()] # O(N)
    list2 = [str2[n:n+2].lower() for n in range(len(str2)-1) if str2[n:n+2].isalpha()] # O(N)

    tlist = set(list1) | set(list2)  # O(N)
